 ...
 * ==========================================
 * 
 * Datos completos del árbol curricular CG Academy con 21 módulos.
 * Implementación exacta del documento maestro proporcionado.
 * 
...
export const categories: Category[] = [
  ...
  },
  {
    ...
    title: 'Organización & Diseño Económico',
...
export const modules: Module[] = [
  // ===== M0: ONBOARDING & SEGURIDAD =====
  {
    ...
    branches: [
        ...
        units: [
            ...
            lessons: [
              {
                ...
                objective: 'Ahora sé instalar y configurar MetaMask correctamente',
                description: 'Instalación paso a paso de MetaMask en dispositivos móviles y desktop, creación de EOA',
                duration: 3,
                difficulty: 'beginner',
              ...
              },
              {
                ...
                objective: 'Ahora sé configurar redes Base en mi wallet',
              ...
              {
                id: 'M0.R1.U1.L3',
                title: 'Habilitar biometría/PIN; bloquear app automáticamente',
                objective: 'Ahora sé asegurar mi wallet con autenticación biométrica',
                description: 'Configurar seguridad biométrica, PIN de acceso y bloqueo automático',
                duration: 2,
                difficulty: 'beginner',
                evidenceType: 'demo',
                evidenceDescription: 'Demostración de acceso seguro con biometría',
                xpReward: 40,
                status: 'locked',
            ...
            lessons: [
              {
                ...
                objective: 'Ahora sé respaldar mi seed phrase de forma completamente segura',
                description: 'Métodos seguros para anotar y guardar seed phrases usando simulador',
                duration: 5,
                difficulty: 'beginner',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz sobre mejores prácticas de backup seguro',
                xpReward: 80,
                status: 'locked',
              ...
              {
                id: 'M0.R1.U2.L2',
                title: 'Probar recuperación en dispositivo secundario (simulada)',
                objective: 'Ahora sé recuperar mi wallet en caso de pérdida',
                description: 'Simulación completa del proceso de recuperación de wallet',
                duration: 4,
                difficulty: 'intermediate',
                evidenceType: 'quest-simulation',
                evidenceDescription: 'Completar simulación de recuperación exitosa',
                xpReward: 70,
                status: 'locked',
          ...
          },
          {
            ...
            lessons: [
              {
                id: 'M0.R1.U3.L1',
                title: 'Firmar mensaje EIP-191 con verificación local',
                objective: 'Ahora sé firmar mensajes criptográficos de forma segura',
                description: 'Firmas criptográficas EIP-191 y proceso de verificación local',
                duration: 4,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Demostración de firma EIP-191 y verificación',
                xpReward: 90,
                status: 'locked',
              ...
              {
                id: 'M0.R1.U3.L2',
                title: '✪ Enviar 0.001 tETH en Base Sepolia; copiar tx hash',
                objective: 'Ahora sé realizar transacciones reales on-chain',
                description: 'Primera transacción real en Base Sepolia testnet',
                duration: 5,
                difficulty: 'intermediate',
                evidenceType: 'quest-onchain',
                evidenceDescription: 'Tx hash de transacción exitosa en Base Sepolia',
                xpReward: 150,
                status: 'locked',
                prerequisites: ['M0.R1.U3.L1'],
                isQuest: true,
                questType: 'onchain',
                questInstructions: 'Enviar exactamente 0.001 tETH a la dirección proporcionada en Base Sepolia',
                verificationSteps: [
                  'Copiar tx hash de la transacción',
              ...
              },
              {
                ...
                description: 'Uso de watchAsset para gestión de tokens ERC-20 personalizados',
                duration: 3,
                difficulty: 'beginner',
                evidenceType: 'screenshot',
      ...
      },
      {
        ...
        description: 'Higiene digital, detección de phishing y sistemas de recuperación',
        units: [
          {
            id: 'M0.R2.U1',
            title: 'Higiene digital',
            description: 'Reconocimiento de amenazas y mejores prácticas de seguridad',
            lessons: [
              {
                id: 'M0.R2.U1.L1',
                title: 'Reconocer URLs falsas y extensiones maliciosas',
                objective: 'Ahora sé identificar y evitar sitios web y extensiones falsas',
                description: 'Técnicas para identificar phishing, URLs maliciosas y extensiones de browser comprometidas',
                duration: 4,
                difficulty: 'beginner',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz sobre identificación de amenazas web',
                xpReward: 70,
                status: 'locked',
              ...
              {
                id: 'M0.R2.U1.L2',
                title: 'Activar 2FA en email y gestor de contraseñas',
                objective: 'Ahora tengo configurada autenticación de dos factores en mis cuentas críticas',
                description: 'Configuración de 2FA en email, gestor de contraseñas y servicios críticos',
                duration: 5,
                difficulty: 'beginner',
                evidenceType: 'screenshot',
              ...
              {
                id: 'M0.R2.U1.L3',
                title: 'Lista de verificación antes de firmar (domain, method, value)',
                objective: 'Ahora tengo un checklist mental antes de firmar cualquier transacción',
                description: 'Checklist de seguridad: verificar dominio, método, valor antes de firmar',
                duration: 3,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Demostración de aplicación del checklist de seguridad',
                xpReward: 60,
                status: 'locked',
          ...
          },
          {
            id: 'M0.R2.U2',
            title: 'Phishing 101',
            description: 'Identificación y prevención de ataques de phishing específicos de crypto',
            lessons: [
              {
                id: 'M0.R2.U2.L1',
                title: 'Identificar "airdrops" falsos y permisos setApprovalForAll',
                objective: 'Ahora sé detectar airdrops falsos y permisos peligrosos',
                description: 'Reconocimiento de airdrops fraudulentos y permisos setApprovalForAll maliciosos',
                duration: 5,
                difficulty: 'intermediate',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz sobre identificación de airdrops y permisos falsos',
                xpReward: 90,
                status: 'locked',
              ...
              },
              {
                ...
                objective: 'Ahora sé revocar permisos de tokens peligrosos',
                description: 'Uso de herramientas de revocación de approvals para proteger tokens',
                duration: 4,
                difficulty: 'intermediate',
                evidenceType: 'quest-simulation',
                evidenceDescription: 'Simulación de revocación de approvals exitosa',
                xpReward: 80,
                status: 'locked',
              ...
              },
              {
                ...
                objective: 'Ahora distingo entre autenticación legítima y firmas peligrosas',
                description: 'Diferencias entre SIWE legítimo y técnicas de firma ciega maliciosas',
                duration: 4,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Demostración de identificación de tipos de firma',
                xpReward: 70,
                status: 'locked',
          ...
          {
            id: 'M0.R2.U3',
            title: 'Recuperación y guardianes',
            description: 'Sistemas de recuperación social y planificación de herencia digital',
            lessons: [
              {
                id: 'M0.R2.U3.L1',
                title: 'Configurar guardianes sociales (demo/sandbox)',
                objective: 'Ahora tengo configurado un sistema de guardianes sociales',
                description: 'Configuración de sistema de recuperación social con guardianes de confianza',
                duration: 6,
                difficulty: 'intermediate',
                evidenceType: 'quest-simulation',
                evidenceDescription: 'Configuración completa de guardianes en ambiente de prueba',
                xpReward: 100,
                status: 'locked',
              ...
              {
                id: 'M0.R2.U3.L2',
                title: 'Simular pérdida de dispositivo y proceso de recuperación',
                objective: 'Ahora sé recuperar mi wallet en caso de pérdida total del dispositivo',
                description: 'Simulación completa de pérdida de dispositivo y recuperación de acceso',
                duration: 5,
                difficulty: 'advanced',
                evidenceType: 'quest-simulation',
                evidenceDescription: 'Simulación exitosa de recuperación completa',
                xpReward: 90,
                status: 'locked',
              ...
              {
                id: 'M0.R2.U3.L3',
                title: 'Definir plan de herencia digital básico',
                objective: 'Ahora tengo un plan de herencia digital para mis activos crypto',
                description: 'Planificación de herencia digital y acceso a activos en caso de fallecimiento',
                duration: 4,
                difficulty: 'advanced',
                evidenceType: 'demo',
      ...
      },
      {
        id: 'M0.R3',
        title: 'Redes & gas',
        description: 'Conceptos de gas, gestión de cuentas y quest de consolidación',
        units: [
          {
            id: 'M0.R3.U1',
            title: 'Conceptos de gas',
            description: 'Base fee, priority fee, gas limit y estrategias de optimización',
            lessons: [
              {
                id: 'M0.R3.U1.L1',
                title: 'Base fee, priority fee, gas limit; estimación manual',
                objective: 'Ahora entiendo completamente el sistema de gas de Ethereum',
                description: 'Conceptos fundamentales: base fee, priority fee, gas limit y cálculos manuales',
                duration: 5,
                difficulty: 'intermediate',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz sobre cálculos de gas y componentes',
                xpReward: 90,
                status: 'locked',
              ...
              },
              {
                ...
                objective: 'Ahora sé interpretar costos de gas en diferentes interfaces',
                description: 'Interpretación de costos de gas en explorers de blockchain y wallets',
                duration: 3,
                difficulty: 'beginner',
                evidenceType: 'screenshot',
              ...
              },
              {
                ...
                objective: 'Ahora sé optimizar costos de gas usando diferentes estrategias',
                description: 'Estrategias de ahorro: horarios óptimos, Layer 2, transacciones en lote',
                duration: 4,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Demostración de estrategias de optimización de gas',
                xpReward: 80,
                status: 'locked',
          ...
          },
          {
            ...
            description: 'EOA vs smart accounts, gestión de nonces y troubleshooting',
            lessons: [
              {
                id: 'M0.R3.U2.L1',
                title: 'EOA vs. smart account (AA) y nonces',
                objective: 'Ahora entiendo las diferencias entre EOA y Account Abstraction',
                description: 'Conceptos: EOA vs smart accounts, Account Abstraction y gestión de nonces',
                duration: 5,
                difficulty: 'intermediate',
                evidenceType: 'quiz',
              ...
              },
              {
                ...
                objective: 'Ahora sé manejar transacciones stuck y reemplazos',
                description: 'Gestión avanzada de nonces, reintentos de transacciones y reemplazos',
                duration: 4,
                difficulty: 'advanced',
                evidenceType: 'demo',
                evidenceDescription: 'Demostración de reemplazo de transacción stuck',
                xpReward: 100,
                status: 'locked',
              ...
              {
                id: 'M0.R3.U2.L3',
                title: 'Errores típicos (out of gas, replacement underpriced)',
                objective: 'Ahora sé diagnosticar y resolver errores comunes de transacciones',
                description: 'Identificación y resolución de errores: out of gas, replacement underpriced, etc.',
                duration: 3,
                difficulty: 'intermediate',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz sobre diagnóstico y resolución de errores',
                xpReward: 70,
                status: 'locked',
          ...
          {
            id: 'M0.R3.U3',
            title: 'Quest de consolidación ✪',
            description: 'Pruebas prácticas para consolidar conocimientos de redes y gas',
            lessons: [
              {
                id: 'M0.R3.U3.L1',
                title: '✪ Enviar y recibir fondos entre dos wallets propias',
                objective: 'Ahora domino completamente las transferencias entre wallets',
                description: 'Quest práctico: gestionar transferencias entre múltiples wallets propias',
                duration: 6,
                difficulty: 'intermediate',
                evidenceType: 'quest-onchain',
                ...
                verificationSteps: [
                  ...
                  'Transferir fondos wallet A → wallet B',
              ...
              {
                id: 'M0.R3.U3.L2',
                title: '✪ Interactuar con faucet Base Sepolia con wallet nueva',
                objective: 'Ahora sé obtener fondos de testnet y gestionar wallets nuevas',
                description: 'Quest: usar faucet de Base Sepolia con wallet recién creada',
                duration: 4,
                difficulty: 'beginner',
                evidenceType: 'quest-onchain',
              ...
              },
              {
                ...
                description: 'Evaluación final: quiz y checklist de preparación para claims reales',
                duration: 3,
                difficulty: 'intermediate',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz final con score ≥80% y checklist completado',
                xpReward: 100,
                status: 'locked',
    ...
    branches: [
      {
        ...
        description: 'Criptografía práctica, estructura de bloques y conceptos de finalidad',
        units: [
          {
            id: 'M1.R1.U1',
            title: 'Criptografía práctica',
            description: 'Hashes, árboles de Merkle y firmas digitales con ejemplos prácticos',
            lessons: [
              {
                id: 'M1.R1.U1.L1',
                title: 'Hashes (SHA-256/Keccak) con ejemplos',
                objective: 'Ahora entiendo cómo funcionan las funciones hash criptográficas',
                description: 'Funciones hash SHA-256 y Keccak-256 con ejemplos prácticos y propiedades',
                duration: 4,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Demostración de cálculo de hashes con herramientas online',
                xpReward: 80,
                status: 'locked',
                prerequisites: ['M0'],
                icon: '#️⃣',
              ...
              {
                id: 'M1.R1.U1.L2',
                title: 'Árboles de Merkle y verificaciones',
                objective: 'Ahora sé cómo funcionan los árboles de Merkle y sus verificaciones',
                description: 'Construcción y verificación de árboles de Merkle para integridad de datos',
                duration: 5,
                difficulty: 'intermediate',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz sobre construcción y verificación de árboles Merkle',
                xpReward: 90,
                status: 'locked',
              ...
              },
              {
                ...
                description: 'Algoritmos ECDSA y ed25519: conceptos, generación y verificación de firmas',
                duration: 4,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Demostración de generación y verificación de firmas',
                xpReward: 85,
                status: 'locked',
          ...
          {            id: 'M1.R1.U2',
            ...
            description: 'Estructura de bloques, transacciones y gestión del estado',
            lessons: [
              {
                id: 'M1.R1.U2.L1',
                title: 'Estructura de un bloque (header, txs, receipts)',
                objective: 'Ahora entiendo completamente la anatomía de un bloque blockchain',
                description: 'Desglose completo: block header, lista de transacciones, receipts y logs',
                duration: 5,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Exploración guiada de un bloque real en BaseScan',
                xpReward: 85,
                status: 'locked',
              ...
              },
              {
                ...
                description: 'Trie de estado: balances, nonces, código de contratos y storage',
                duration: 6,
                difficulty: 'advanced',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz avanzado sobre gestión de estado y tries',
                xpReward: 100,
                status: 'locked',
              ...
              },
              {
                ...
                objective: 'Ahora sé interpretar transacciones completas y sus eventos',
                description: 'Estructura de transacciones, decodificación de input data, logs y eventos',
                duration: 4,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Decodificar una transacción compleja con eventos',
                xpReward: 90,
                status: 'locked',
          ...
          },
          {
            ...
            description: 'Confirmaciones, finalidad probabilística y manejo de reorgs',
            lessons: [
              {
                id: 'M1.R1.U3.L1',
                title: 'Confirmaciones y finalidad probabilística',
                objective: 'Ahora entiendo cuándo una transacción es realmente final',
                description: 'Concepto de confirmaciones, finalidad probabilística vs determinística',
                duration: 4,
                difficulty: 'intermediate',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz sobre finalidad y número de confirmaciones seguras',
                xpReward: 80,
                status: 'locked',
              ...
              {
                id: 'M1.R1.U3.L2',
                title: 'Reorganizaciones: cuándo y por qué',
                objective: 'Ahora comprendo los riesgos de reorganizaciones blockchain',
                description: 'Causas de reorgs, detección, impacto en transacciones y mitigación',
                duration: 5,
                difficulty: 'advanced',
                evidenceType: 'demo',
                evidenceDescription: 'Análisis de casos reales de reorganizaciones',
                xpReward: 95,
                status: 'locked',
              ...
              {
                id: 'M1.R1.U3.L3',
                title: '✪ Monitorear confirmaciones de una tx crítica',
                objective: 'Ahora sé monitorear transacciones críticas hasta finalidad',
                description: 'Quest: monitorear una transacción importante hasta confirmación segura',
                duration: 6,
                difficulty: 'intermediate',
                evidenceType: 'quest-simulation',
                evidenceDescription: 'Demostración de monitoreo completo con herramientas',
                xpReward: 120,
                status: 'locked',
                prerequisites: ['M1.R1.U3.L2'],
                isQuest: true,
                questType: 'simulation',
                questInstructions: 'Monitorear transacción desde mempool hasta 12 confirmaciones',
                verificationSteps: [
                  'Identificar tx en mempool',
                  'Seguir inclusión en bloque',
      ...
      },
      {
        id: 'M1.R2',
        title: 'Consenso',
        description: 'Proof of Work, Proof of Stake y teoría de juegos del consenso',
        units: [
          {
            id: 'M1.R2.U1',
            title: 'Proof of Work',
            description: 'Mining, dificultad y economía del PoW',
            lessons: [
              {
                id: 'M1.R2.U1.L1',
                title: 'Mining y ajuste de dificultad',
                objective: 'Ahora entiendo el proceso de mining y ajuste dinámico de dificultad',
                description: 'Proceso de mining, target de dificultad, ajustes y hashrate',
                duration: 5,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Simulación de proceso de mining con ajuste de dificultad',
                xpReward: 85,
                status: 'locked',
              ...
              {
                id: 'M1.R2.U1.L2',
                title: 'Incentivos económicos y recompensas',
                objective: 'Ahora comprendo la economía detrás del Proof of Work',
                description: 'Block rewards, fees, halving, economía de mineros',
                duration: 4,
                difficulty: 'intermediate',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz sobre economía de mining y recompensas',
                xpReward: 75,
                status: 'locked',
              ...
              },
              {
                ...
                description: 'Análisis de ataques 51%, double spending, costos de ataque',
                duration: 5,
                difficulty: 'advanced',
                evidenceType: 'demo',
                evidenceDescription: 'Cálculo de costos para ataque 51% en diferentes chains',
                xpReward: 95,
                status: 'locked',
          ...
          },
          {
            ...
            description: 'Validadores, slashing y economía del PoS',
            lessons: [
              {
                id: 'M1.R2.U2.L1',
                ...
                difficulty: 'intermediate',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz sobre validadores y mecánicas de staking',
                xpReward: 85,
                status: 'locked',
              ...
              },
              {
                ...
                objective: 'Ahora comprendo los mecanismos de penalización en PoS',
                description: 'Condiciones de slashing, inactivity leak, penalizaciones',
                duration: 4,
                difficulty: 'advanced',
                evidenceType: 'demo',
                evidenceDescription: 'Análisis de casos reales de slashing',
                xpReward: 90,
                status: 'locked',
              ...
              {
                id: 'M1.R2.U2.L3',
                title: 'Comparación PoW vs PoS (trade-offs)',
                objective: 'Ahora puedo evaluar pros y contras de PoW vs PoS',
                description: 'Análisis comparativo: seguridad, descentralización, eficiencia',
                duration: 3,
                difficulty: 'intermediate',
                evidenceType: 'quiz',
            ...
            lessons: [
              {
                ...
                objective: 'Ahora entiendo la teoría de juegos aplicada a blockchain',
                description: 'Teoría de incentivos, equilibrio de Nash, racionalidad económica',
                duration: 5,
                difficulty: 'advanced',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz sobre teoría de juegos y incentivos',
                xpReward: 95,
                status: 'locked',
              ...
              {
                id: 'M1.R2.U3.L3',
                title: '✪ Detectar MEV en una transacción propia',
                objective: 'Ahora sé detectar y prevenir MEV en mis transacciones',
                description: 'Quest: analizar transacciones propias para detectar MEV',
                duration: 5,
                difficulty: 'advanced',
                evidenceType: 'quest-simulation',
                evidenceDescription: 'Reporte de análisis MEV en transacción propia',
                xpReward: 130,
                status: 'locked',
                prerequisites: ['M1.R2.U3.L2'],
                isQuest: true,
                questType: 'simulation',
                questInstructions: 'Analizar transacción swap para detectar MEV potencial',
                verificationSteps: [
                  'Identificar transacción de swap',
                  'Analizar mempool antes/después',
      ...
      },
      {
        id: 'M1.R3',
        title: 'Herramientas',
        description: 'Explorers, APIs y herramientas de análisis blockchain',
        units: [
          {
            id: 'M1.R3.U1',
            title: 'Explorers avanzado',
            description: 'Uso profesional de explorers para análisis profundo',
            lessons: [
              {
                id: 'M1.R3.U1.L1',
                title: 'Leer contratos verificados y ABIs',
                objective: 'Ahora sé navegar y entender contratos verificados',
                description: 'Lectura de código fuente, ABIs, funciones read/write en explorers',
                duration: 5,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Navegación guiada de contrato complejo en BaseScan',
                xpReward: 85,
                status: 'locked',
              ...
              },
              {
                ...
                difficulty: 'advanced',
                evidenceType: 'demo',
                evidenceDescription: 'Debug de transacción fallida con trace analysis',
                xpReward: 100,
                status: 'locked',
              ...
              },
              {
                ...
                objective: 'Ahora sé analizar métricas on-chain de tokens y contratos',
                description: 'Análisis de holders, volumen, actividad, distribución',
                duration: 4,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Reporte analítico de token usando explorer',
                xpReward: 80,
                status: 'locked',
          ...
          },
          {
            id: 'M1.R3.U2',
            title: 'APIs y datos',
            description: 'Acceso programático a datos blockchain',
            lessons: [
              {
                id: 'M1.R3.U2.L1',
                title: 'JSON-RPC básico (eth_call, eth_getBalance)',
                objective: 'Ahora sé hacer llamadas RPC básicas a nodos',
                description: 'Introducción a JSON-RPC: consultas de balance, estado, llamadas',
                duration: 5,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Realizar llamadas RPC básicas con curl/postman',
                xpReward: 85,
                status: 'locked',
              ...
              },
              {
                ...
                description: 'Comparación de servicios RPC, features, límites, pricing',
                duration: 3,
                difficulty: 'beginner',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz sobre servicios RPC y sus características',
                xpReward: 60,
                status: 'locked',
          ...
          {
            id: 'M1.R3.U3',
            title: 'Quest integrador ✪',
            description: 'Proyecto final integrando todos los conocimientos',
            lessons: [
              {
                id: 'M1.R3.U3.L1',
                title: '✪ Crear dashboard personal de actividad',
                objective: 'Ahora puedo crear herramientas de análisis propias',
                description: 'Quest: crear dashboard mostrando actividad de wallet propia',
                duration: 8,
                difficulty: 'advanced',
                evidenceType: 'quest-demo',
                evidenceDescription: 'Dashboard funcional con al menos 5 métricas',
                xpReward: 150,
                status: 'locked',
              ...
              {
                id: 'M1.R3.U3.L2',
                title: '✪ Análisis forense de hack/exploit',
              ...
              },
              {
                ...
                objective: 'Certificación oficial de dominio de fundamentos',
                description: 'Evaluación final comprehensiva del módulo',
                duration: 5,
                difficulty: 'advanced',
                evidenceType: 'quiz',
                evidenceDescription: 'Examen final con score ≥85% para certificación',
                xpReward: 200,
                status: 'locked',
        ...
        badgeDescription: 'Maestro en herramientas y análisis blockchain',
        icon: '🛠️',
        color: '#06B6D4',
  ...
  // ===== M2: SMART CONTRACTS & DAPPS =====
  {
    ...
    description: 'EVM, Solidity básico, interacción con contratos y patrones de DApps',
    objective: 'Dominar interacción con smart contracts y arquitectura de aplicaciones descentralizadas',
    branches: [
      {
        id: 'M2.R1',
        title: 'EVM & Solidity',
        description: 'Máquina virtual de Ethereum y fundamentos de Solidity',
        units: [
          {
            id: 'M2.R1.U1',
            title: 'EVM básico',
            ...
            lessons: [
              {
                id: 'M2.R1.U1.L1',
                title: 'Stack, memory, storage: modelo de ejecución',
                objective: 'Ahora entiendo la arquitectura de ejecución de la EVM',
                description: 'Stack machine, memory volátil, storage persistente, calldata',
                duration: 6,
                difficulty: 'advanced',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz sobre arquitectura EVM y modelo de ejecución',
                xpReward: 100,
                status: 'locked',
                prerequisites: ['M1'],
                icon: '🖥️',
              ...
              },
              {
                ...
                objective: 'Ahora conozco los opcodes más importantes y sus costos',
                description: 'SSTORE, SLOAD, CALL, CREATE, costos de gas por operación',
                duration: 5,
                difficulty: 'advanced',
                evidenceType: 'demo',
                evidenceDescription: 'Análisis de opcodes en transacción real',
                xpReward: 95,
                status: 'locked',
              ...
              },
              {
                ...
                objective: 'Ahora sé codificar y decodificar datos ABI',
                description: 'Application Binary Interface, encoding de parámetros, function selectors',
                duration: 4,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Codificar/decodificar llamada a función manualmente',
                xpReward: 85,
                status: 'locked',
          ...
          },
          {
            ...
            description: 'Sintaxis básica, tipos de datos y control de flujo',
            lessons: [
              {
                id: 'M2.R1.U2.L1',
              ...
              },
              {
                ...
                objective: 'Ahora sé escribir funciones con modifiers y emitir eventos',
              ...
              {
                id: 'M2.R1.U2.L3',
                title: '✪ Deploy contrato "Hello World" en testnet',
                ...
                difficulty: 'intermediate',
                evidenceType: 'quest-onchain',
                evidenceDescription: 'Dirección del contrato deployado en Base Sepolia',
                xpReward: 150,
                status: 'locked',
                prerequisites: ['M2.R1.U2.L2'],
                isQuest: true,
                questType: 'onchain',
                questInstructions: 'Deployar contrato HelloWorld con función getMessage',
                verificationSteps: [
          ...
          },
          {
            ...
            description: 'Patrones comunes y consideraciones de seguridad básicas',
            lessons: [
              {
                id: 'M2.R1.U3.L1',
                title: 'Reentrancy y checks-effects-interactions',
                objective: 'Ahora entiendo y prevengo ataques de reentrancy',
                description: 'Patrón CEI, mutex/reentrancy guards, ejemplos de exploits',
                duration: 6,
                difficulty: 'advanced',
                evidenceType: 'demo',
              ...
              },
              {
                ...
                objective: 'Ahora sé prevenir errores aritméticos en contratos',
                description: 'Integer overflow/underflow, SafeMath, Solidity 0.8+',
                duration: 4,
                difficulty: 'intermediate',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz sobre prevención de overflow/underflow',
                xpReward: 75,
                status: 'locked',
        ...
        units: [
          {
            ...
            description: 'Web3.js y Ethers.js para interacción con contratos',
            lessons: [
              {
                id: 'M2.R2.U1.L1',
                ...
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Demo de conexión y lectura de contrato',
                xpReward: 85,
                status: 'locked',
              ...
              },
              {
                ...
                objective: 'Ahora sé enviar transacciones optimizadas',
                description: 'Write functions, gas estimation, transaction management',
                duration: 6,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Enviar transacción con estimación de gas óptima',
                xpReward: 95,
                status: 'locked',
            ...
            lessons: [
              {
                ...
                description: 'Setup Hardhat, compilación, testing, deployment scripts',
                duration: 7,
                difficulty: 'intermediate',
                evidenceType: 'demo',
              ...
              },
              {
                ...
                description: 'Forge para testing, cast para interacción, fuzzing',
                duration: 6,
                difficulty: 'advanced',
                evidenceType: 'demo',
              ...
              },
              {
                ...
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Debug de transacción fallida con Tenderly',
                xpReward: 80,
                status: 'locked',
          ...
          },
          {
            ...
            description: 'Construcción de DApps con React y Web3',
            lessons: [
              {
                id: 'M2.R2.U3.L1',
                title: 'React + Web3Modal',
                objective: 'Ahora puedo construir interfaces Web3 con React',
                description: 'Integración React, Web3Modal, wallet connection flow',
                duration: 6,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'DApp React con conexión multi-wallet',
                xpReward: 95,
                status: 'locked',
              ...
              {
                id: 'M2.R2.U3.L3',
                title: '✪ Build mini-DApp completa',
                ...
                isQuest: true,
                questType: 'demo',
                questInstructions: 'Crear DApp de votación, NFT minting o token swap',
                verificationSteps: [
      ...
      },
      {
        ...
        description: 'Patrones de diseño, storage descentralizado y oráculos',
        units: [
          {
            id: 'M2.R3.U1',
            ...
            lessons: [
              ...
              },
              {
                ...
                objective: 'Ahora sé implementar contratos actualizables',
              ...
              },
              {
                ...
                objective: 'Ahora entiendo el patrón diamond para modularidad',
          ...
          },
          {
            ...
            lessons: [
              ...
              },
              {
                ...
                objective: 'Ahora diseño arquitecturas híbridas on/off-chain',
                description: 'On-chain references, off-chain data, verification, cost optimization',
                duration: 5,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Diseñar sistema híbrido para NFT metadata',
                xpReward: 90,
                status: 'locked',
          ...
          {
            id: 'M2.R3.U3',
            title: 'Oráculos y datos externos',
            description: 'Chainlink, price feeds y verificación de datos',
            lessons: [
              {
                id: 'M2.R3.U3.L1',
              ...
              },
              {
                ...
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Implementar lotería con VRF y automation',
                xpReward: 100,
                status: 'locked',
              ...
              {
                id: 'M2.R3.U3.L3',
                title: '✪ Integrar oráculo en DApp',
                objective: 'Ahora construyo DApps con datos del mundo real',
                description: 'Quest: DApp completa con integración de oráculos',
                duration: 8,
                difficulty: 'advanced',
                evidenceType: 'quest-demo',
                evidenceDescription: 'DApp funcional usando oráculos para datos externos',
                xpReward: 180,
                status: 'locked',
                prerequisites: ['M2.R3.U3.L2'],
                isQuest: true,
                questType: 'demo',
                questInstructions: 'Crear DApp de predicción/betting con price feeds',
                verificationSteps: [
  ...
  // ===== M3: GOBERNANZA & COORDINACIÓN =====
  {
    id: 'M3',
    title: 'Gobernanza & Coordinación',
    description: 'DAOs, votación on-chain, mecanismos de coordinación y teoría de juegos aplicada',
    objective: 'Dominar sistemas de gobernanza descentralizada y mecanismos de coordinación colectiva',
    branches: [
      {
        id: 'M3.R1',
        title: 'DAOs fundamentals',
        description: 'Organizaciones autónomas descentralizadas y sus mecanismos',
        units: [
          {
            id: 'M3.R1.U1',
            title: 'Anatomía de una DAO',
            description: 'Estructura, componentes y tipos de DAOs',
            lessons: [
              {
                id: 'M3.R1.U1.L1',
                title: 'Qué es una DAO y casos de uso',
                objective: 'Ahora entiendo qué son las DAOs y sus aplicaciones reales',
                description: 'Concepto de DAO, historia, casos de éxito y fracaso, tipos de DAOs',
                duration: 4,
                difficulty: 'intermediate',
                evidenceType: 'quiz',
              ...
              },
              {
                ...
                objective: 'Ahora sé gestionar treasuries con multisigs',
                description: 'Gnosis Safe, treasury management, políticas de gasto, multisig setup',
                duration: 5,
                difficulty: 'intermediate',
                evidenceType: 'demo',
              ...
              },
              {
                ...
                description: 'Token-based vs NFT membership, distribución, vesting, delegation',
                duration: 4,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Diseñar sistema de membership para DAO',
                xpReward: 80,
                status: 'locked',
          ...
          },
          {
            ...
            lessons: [
              {
                id: 'M3.R1.U2.L1',
                title: 'Snapshot: votación off-chain',
              ...
              },
              {
                ...
                objective: 'Ahora implemento votación on-chain con Governor',
              ...
              {
                id: 'M3.R1.U2.L3',
                title: '✪ Crear mini-DAO funcional',
          ...
          },
          {
            ...
            lessons: [
              ...
              {
                id: 'M3.R1.U3.L2',
                title: 'SubDAOs y estructura jerárquica',
                objective: 'Ahora diseño estructuras de DAOs complejas',
                description: 'SubDAOs, working groups, committees, delegation frameworks',
                duration: 4,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Diseñar estructura de DAO con subDAOs',
                xpReward: 75,
                status: 'locked',
        ...
        badgeDescription: 'Operador experto de organizaciones autónomas descentralizadas',
        icon: '🏛️',
        color: '#8B5CF6',
      ...
      },
      {
        ...
        description: 'Mecanismos de votación, delegación y participación',
        units: [
          {
            id: 'M3.R2.U1',
            title: 'Mecanismos de votación',
            description: 'Diferentes sistemas de votación y sus propiedades',
            lessons: [
              {
                id: 'M3.R2.U1.L1',
                title: 'Token-weighted vs quadratic voting',
                objective: 'Ahora comprendo diferentes mecanismos de votación',
                description: 'Linear voting, quadratic voting, conviction voting, pros y contras',
                duration: 5,
                difficulty: 'intermediate',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz sobre mecanismos de votación',
                xpReward: 85,
                status: 'locked',
              ...
              },
              {
                ...
                objective: 'Ahora entiendo sistemas de delegación avanzados',
                description: 'Vote delegation, liquid democracy, delegate incentives, metagovernance',
                duration: 4,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Implementar sistema de delegación',
                xpReward: 80,
                status: 'locked',
              ...
              {
                id: 'M3.R2.U1.L3',
                title: 'Quorum y participación',
                objective: 'Ahora optimizo quorum y participación',
                description: 'Quorum requirements, participation incentives, voter apathy solutions',
                duration: 3,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Diseñar sistema de incentivos para participación',
                xpReward: 70,
                status: 'locked',
          ...
          },
          {
            ...
            lessons: [
              ...
              {
                id: 'M3.R2.U2.L2',
                title: 'Discusión y temperature checks',
                ...
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Facilitar discusión de propuesta en forum',
                xpReward: 65,
                status: 'locked',
              ...
              {
                id: 'M3.R2.U2.L3',
                title: 'Ejecución y post-mortem',
                objective: 'Ahora ejecuto y evalúo propuestas',
                description: 'Proposal execution, monitoring, success metrics, post-mortem analysis',
                duration: 4,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Ejecutar propuesta y hacer análisis post-mortem',
                xpReward: 80,
                status: 'locked',
            ...
            lessons: [
              {
                ...
                difficulty: 'advanced',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz sobre vectores de ataque y prevención',
                xpReward: 95,
                status: 'locked',
        ...
        badgeDescription: 'Experto en sistemas de votación y gobernanza',
        icon: '🗳️',
        color: '#06B6D4',
      ...
      {
        id: 'M3.R3',
        title: 'Coordinación y teoría de juegos',
        description: 'Mecanismos de coordinación, incentivos y equilibrios',
        units: [
          {
            id: 'M3.R3.U1',
            title: 'Mecanismos de coordinación',
            description: 'Herramientas para coordinar acción colectiva',
            lessons: [
              {
                id: 'M3.R3.U1.L1',
                title: 'Schelling points y señalización',
                objective: 'Ahora uso Schelling points para coordinación',
                description: 'Focal points, signaling theory, coordination games, common knowledge',
                duration: 4,
                difficulty: 'advanced',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz sobre teoría de coordinación',
                xpReward: 85,
                status: 'locked',
              ...
              },
              {
                ...
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Diseñar sistema de RetroPGF',
                xpReward: 75,
                status: 'locked',
          ...
          {
            id: 'M3.R3.U2',
            title: 'Diseño de incentivos',
            description: 'Creación de sistemas de incentivos efectivos',
            lessons: [
              {
                id: 'M3.R3.U2.L1',
                title: 'Token economics básico',
                objective: 'Ahora diseño tokenomics básicos',
                description: 'Supply mechanics, distribution, utility, value accrual, sinks and faucets',
                duration: 5,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Diseñar tokenomics para protocolo',
                xpReward: 90,
                status: 'locked',
              ...
              },
              {
                ...
                objective: 'Ahora diseño bonding curves',
          ...
          },
          {
            ...
            lessons: [
              {
                id: 'M3.R3.U3.L1',
                title: '✪ Diseñar constitución y estructura',
                objective: 'Ahora puedo diseñar DAOs completas',
                description: 'Quest: crear constitución y estructura de DAO',
                duration: 6,
                difficulty: 'advanced',
                evidenceType: 'quest-demo',
                evidenceDescription: 'Documento de constitución y estructura completo',
                xpReward: 120,
                status: 'locked',
                prerequisites: ['M3.R3.U2.L3'],
                isQuest: true,
                questType: 'demo',
                questInstructions: 'Crear constitución con valores, estructura y procesos',
                verificationSteps: [
              ...
              {
                id: 'M3.R3.U3.L2',
                title: '✪ Lanzar DAO con comunidad inicial',
              ...
              },
              {
                ...
                objective: 'Certificación en gobernanza y coordinación',
                description: 'Evaluación final del módulo de gobernanza',
                duration: 5,
                difficulty: 'advanced',
                evidenceType: 'quiz',
                evidenceDescription: 'Examen comprehensivo con score ≥85%',
                xpReward: 180,
                status: 'locked',
        ...
        badgeDescription: 'Maestro en coordinación y teoría de juegos aplicada',
        icon: '○',
        color: '#EC4899',
    ...
    categoryTitle: 'Organización & Diseño Económico',
    depth: 'high',
    prerequisites: ['M2'],
  ...
  // ===== M4: TOKENS & CRIPTO ACTIVOS =====
  {
    ...
    description: 'ERC-20, ERC-721, ERC-1155, DeFi básico y economía de tokens',
    objective: 'Dominar estándares de tokens, NFTs y fundamentos de DeFi',
    branches: [
      {
        id: 'M4.R1',
        title: 'Tokens fungibles (ERC-20)',
        description: 'Estándar ERC-20, stablecoins y wrapped tokens',
        units: [
          {
            id: 'M4.R1.U1',
            title: 'Estándar ERC-20',
            description: 'Anatomía y funciones del estándar ERC-20',
            lessons: [
              {
                id: 'M4.R1.U1.L1',
                title: 'Anatomía de un token ERC-20',
                objective: 'Ahora entiendo completamente el estándar ERC-20',
              ...
              {
                id: 'M4.R1.U1.L2',
                title: 'Decimals y precisión',
                objective: 'Ahora manejo decimales y precisión en tokens',
              ...
              },
              {
                ...
                objective: 'Ahora sé gestionar el supply de tokens',
          ...
          },
          {
            ...
            lessons: [
              ...
              {
                id: 'M4.R1.U2.L2',
                title: 'Mecanismos de peg y colateralización',
                objective: 'Ahora entiendo cómo mantienen su valor las stablecoins',
                description: 'Peg mechanisms, collateralization ratios, redemption, arbitrage',
                duration: 6,
                difficulty: 'advanced',
                evidenceType: 'demo',
                evidenceDescription: 'Análisis de peg mechanism de DAI',
                xpReward: 95,
                status: 'locked',
          ...
          },
          {
            ...
            lessons: [
              ...
              },
              {
                ...
                objective: 'Ahora sé mover tokens entre chains',
              ...
              {
                id: 'M4.R1.U3.L3',
                title: '✪ Deploy y verificar token ERC-20',
        ...
        units: [
          {
            ...
            description: 'NFTs básicos y su implementación',
            lessons: [
              {
                id: 'M4.R2.U1.L1',
                title: 'Anatomía ERC-721: ownership y uniqueness',
                objective: 'Ahora entiendo el estándar ERC-721',
          ...
          },
          {
            ...
            lessons: [
              ...
              },
              {
                ...
                objective: 'Ahora diseño sistemas de items para gaming',
                description: 'Game items, editions, supply per token ID, balance batch queries',
                duration: 6,
                difficulty: 'intermediate',
                evidenceType: 'demo',
                evidenceDescription: 'Diseñar sistema de items para juego',
                xpReward: 95,
                status: 'locked',
          ...
          },
          {
            ...
            lessons: [
              ...
              {
                id: 'M4.R2.U3.L3',
                title: '✪ Lanzar colección NFT completa',
                objective: 'Ahora puedo lanzar colecciones NFT profesionales',
                description: 'Quest: crear y lanzar colección NFT con metadata y marketplace',
                duration: 10,
                difficulty: 'advanced',
                evidenceType: 'quest-demo',
                evidenceDescription: 'Colección NFT lanzada con 10+ items',
                xpReward: 180,
                status: 'locked',
                prerequisites: ['M4.R2.U3.L2'],
                isQuest: true,
                questType: 'demo',
                questInstructions: 'Crear colección con art, metadata, smart contract y listing',
                verificationSteps: [
      ...
      },
      {
        ...
        units: [
            ...
            lessons: [
              {
                ...
                objective: 'Ahora entiendo la fórmula básica de AMMs',
                description: 'Constant product formula, price impact, slippage, impermanent loss',
                duration: 6,
                difficulty: 'advanced',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz sobre mecánicas de AMM',
                xpReward: 100,
                status: 'locked',
              ...
              },
              {
                ...
                objective: 'Ahora sé proveer liquidez en pools',
          ...
          },
          {
            ...
            description: 'Protocolos de préstamos descentralizados',
            lessons: [
              {
                id: 'M4.R3.U2.L1',
              ...
              },
              {
                ...
                objective: 'Ahora gestiono riesgo de liquidación',
                description: 'LTV ratios, health factor, liquidation threshold, liquidation bonus',
                duration: 5,
                difficulty: 'intermediate',
                evidenceType: 'quiz',
                evidenceDescription: 'Quiz sobre gestión de riesgo en lending',
                xpReward: 85,
                status: 'locked',
          ...
          },
          {
            ...
            lessons: [
              ...
              {
                id: 'M4.R3.U3.L3',
                title: '✪ Estrategia DeFi completa',
                objective: 'Ahora diseño estrategias DeFi complejas',
                description: 'Quest: implementar estrategia combinando AMM, lending y farming',
                duration: 8,
                difficulty: 'advanced',
                evidenceType: 'quest-simulation',
                evidenceDescription: 'Estrategia rentable en simulación',
                xpReward: 160,
                status: 'locked',
                prerequisites: ['M4.R3.U3.L2'],
                isQuest: true,
                questType: 'simulation',
                questInstructions: 'Diseñar estrategia con 3+ protocolos DeFi',
                verificationSteps: [
...
// ===== MÓDULOS AVANZADOS (M5-M8) - PROFUNDIDAD ALTA =====

const M5_DEFI_CORE: Module = {
  id: 'M5',
  title: 'DeFi Core 2025',
  description: '🔮 DeFi Core 2025: Ecosistema DeFi de próxima generación con Restaking, Liquid Staking, Cross-chain Protocols, y AMM V4. Incluye Uniswap V4, Curve Finance, SushiSwap y protocolos emergentes en Base blockchain.',
  ...
  branches: [
      ...
      units: [
        {
          id: '5.1.1',
          title: 'AMM básico',
          description: 'Fundamentos de Automated Market Makers y fórmulas de precios',
          lessons: [
            {
              id: '5.1.1.1',
              title: '⚡ AMM 2025: V4 Hooks & Concentrated Liquidity',
              objective: 'Ahora domino AMM avanzados con hooks personalizables y liquidez concentrada',
              description: '🚀 Uniswap V4 hooks, Curve V2 pools, SushiSwap V3 concentrada. Fórmulas x·y=k evolution, custom hooks, MEV protection integrada.',
              duration: 12,
              difficulty: 'advanced',
              evidenceType: 'quiz',
              evidenceDescription: 'Quiz AMM V4 con hooks y concentrated liquidity ≥85%',
              xpReward: 120,
              status: 'locked',
              isQuest: false,
              icon: '⚡',
            ...
            {
              id: '5.1.1.2',
              title: '🛡️ MEV Protection & Smart Slippage 2025',
              objective: 'Ahora sé protegerme del MEV y optimizar slippage con IA',
              description: '🧠 Smart slippage con ML algorithms, MEV protection protocols, intents-based trading. Base blockchain optimizations y private mempools.',
              duration: 10,
              difficulty: 'advanced',
              evidenceType: 'quest-simulation',
              evidenceDescription: 'Simular trades con protección MEV en Base testnet',
              xpReward: 100,
              status: 'locked',
              isQuest: true,
              questType: 'simulation',
            ...
            {
              id: '5.1.1.3',
              title: '🔮 IL Mitigation & Restaking Yields 2025',
              objective: 'Ahora sé mitigar IL con restaking protocols y yield optimization',
              description: '⚡ EigenLayer restaking, Lido liquid staking evolution, IL insurance protocols. Dynamic hedge strategies y cross-chain yield optimization.',
              duration: 15,
              difficulty: 'advanced',
              evidenceType: 'quiz',
              evidenceDescription: 'Resolver casos prácticos de IL ≥80%',
              xpReward: 90,
              status: 'locked',
              isQuest: false,
              icon: '⚠️',
        ...
        },
        {
          id: '5.1.2',
          title: 'Práctica DEX ✪',
          description: 'Interacciones prácticas con AMM en testnet',
          lessons: [
            {
              id: '5.1.2.1',
              title: '✪ Swap en Base test',
              objective: 'Ahora sé hacer swaps en DEX descentralizados',
              ...
              isQuest: true,
              questType: 'onchain',
              questInstructions: 'Conectar wallet, hacer swap tETH→tUSDC, documentar tx hash',
            ...
            {
              id: '5.1.2.2',
              title: '✪ Añadir/quitar liquidez con recibo LP',
              objective: 'Ahora sé proveer liquidez y gestionar LP tokens',
              description: 'Añadir liquidez a pool y recibir LP tokens, luego retirar',
              duration: 15,
              difficulty: 'advanced',
              evidenceType: 'quest-onchain',
            ...
            },
            {
              ...
              objective: 'Ahora sé analizar pools de liquidez usando explorers',
              description: 'Analizar métricas de pools: TVL, volumen, fees generados',
              duration: 8,
              difficulty: 'intermediate',
              evidenceType: 'screenshot',
              evidenceDescription: 'Screenshot analizando pool con métricas explicadas',
              xpReward: 70,
              status: 'locked',
              isQuest: false,
              icon: '🔵',
        ...
        {
          id: '5.1.3',
          title: '🌐 Cross-Chain Aggregators 2025',
          description: '🔮 Next-gen aggregators: Multi-chain routing, intent-based protocols, AI price optimization. Cross L1/L2/Base ecosystem.',
          lessons: [
            {
              id: '5.1.3.1',
              title: '🚀 AI-Powered Multi-Chain Routing',
              objective: 'Ahora domino routing inteligente cross-chain con IA',
              description: '🤖 Machine learning routing algorithms, cross-chain bridges optimization, Base-Ethereum-L2 best paths. Real-time gas & bridge fee optimization.',
              duration: 10,
              difficulty: 'advanced',
              evidenceType: 'quest-simulation',
              evidenceDescription: 'Optimizar route cross-chain Base→Ethereum con AI routing',
              xpReward: 90,
              status: 'locked',
              isQuest: true,
              questType: 'simulation',
            ...
            {
              id: '5.1.3.2',
              title: 'MEV y protección básica',
              objective: 'Ahora sé identificar y protegerme del MEV',
              description: 'MEV, sandwich attacks y estrategias de protección',
              duration: 9,
              difficulty: 'advanced',
              evidenceType: 'quiz',
              evidenceDescription: 'Resolver casos de MEV y protección ≥80%',
              xpReward: 85,
              status: 'locked',
              isQuest: false,
              icon: '🛡️',
            ...
            },
            {
              ...
              difficulty: 'intermediate',
              evidenceType: 'quiz',
              evidenceDescription: 'Quiz final AMM ≥80%',
              xpReward: 50,
              status: 'locked',
              isQuest: false,
              icon: '🎯',
    ...
    // R2: Lending/borrowing
    {
      id: '5.2',
      title: 'Lending/borrowing',
      description: 'Protocolos de préstamos: colateral, liquidaciones, interest rates y gestión de riesgo.',
      units: [
        {
          id: '5.2.1',
          title: 'Conceptos',
          ...
          lessons: [
            {
              ...
              objective: 'Ahora sé gestionar colateral y evitar liquidaciones',
              description: 'Loan-to-Value ratios, collateral requirements y liquidation triggers',
              duration: 10,
              difficulty: 'intermediate',
              evidenceType: 'quiz',
              evidenceDescription: 'Quiz sobre LTV y liquidaciones ≥80%',
              xpReward: 90,
              status: 'locked',
              isQuest: false,
              icon: '💎',
            ...
            {
              id: '5.2.1.2',
              title: 'Tipos de interés; variables/fijas',
              objective: 'Ahora sé elegir el mejor tipo de interés',
              description: 'Interest rate models: variable vs fixed, supply/demand dynamics',
              duration: 8,
              difficulty: 'intermediate',
              evidenceType: 'quiz',
              evidenceDescription: 'Comparar tipos de interés en diferentes escenarios',
              xpReward: 75,
              status: 'locked',
              isQuest: false,
              icon: '📈',
            ...
            },
            {
              id: '5.2.1.3',
              title: 'Health factor',
              objective: 'Ahora sé monitorear y mantener mi health factor',
        ...
        },
        {
          ...
          lessons: [
            {
              id: '5.2.2.1',
              title: '✪ Depositar colateral y pedir préstamo pequeño',
              objective: 'Ahora sé usar protocolos de lending de forma segura',
              description: 'Depositar ETH como colateral y pedir préstamo de USDC',
              duration: 18,
              difficulty: 'advanced',
              evidenceType: 'quest-onchain',
            ...
            {
              id: '5.2.2.2',
              title: '✪ Simular liquidación y repago',
              objective: 'Ahora sé manejar liquidaciones y repagos',
              description: 'Simular scenarios de liquidación y proceso de repago',
              duration: 15,
              difficulty: 'advanced',
              evidenceType: 'quest-simulation',
            ...
            },
            {
              ...
              objective: 'Ahora sé rastrear liquidaciones on-chain',
              description: 'Leer y analizar eventos de liquidación en explorers',
              duration: 10,
              difficulty: 'intermediate',
              evidenceType: 'screenshot',
              evidenceDescription: 'Screenshot de análisis de evento LiquidationCall',
              xpReward: 90,
              status: 'locked',
              isQuest: false,
              icon: '🔵',
          ...
          lessons: [
            {
              ...
              objective: 'Ahora sé identificar riesgos de oráculo',
              description: 'Price oracle failures y liquidation cascades',
              duration: 9,
              difficulty: 'advanced',
              evidenceType: 'quiz',
              evidenceDescription: 'Analizar casos históricos de oracle failures',
              xpReward: 85,
              status: 'locked',
              isQuest: false,
              icon: '🔵',
            ...
            },
            {
              ...
              objective: 'Ahora sé evaluar riesgos de smart contracts',
              description: 'Protocol risk assessment y due diligence',
              duration: 8,
              difficulty: 'advanced',
              evidenceType: 'quiz',
              evidenceDescription: 'Checklist de evaluación de protocol risk',
              xpReward: 80,
              status: 'locked',
              isQuest: false,
              icon: '⚠️',
            ...
            },
            {
              ...
              difficulty: 'intermediate',
              evidenceType: 'quiz',
              evidenceDescription: 'Quiz final DeFi lending ≥80%',
              xpReward: 60,
              status: 'locked',
              isQuest: false,
              icon: '🎯',
...
const M6_NFT_DIGITAL_MEDIA: Module = {
  ...
  description: '🎨 NFT Revolution 2025: ERC-6551 Token Bound Accounts, Dynamic NFTs con IA, Phygital experiences, Music NFTs con royalties automáticas. Intelligent NFTs (iNFTs) y utility-first approach.',
  objective: 'Dominar NFTs next-gen: TBA wallets, dynamic metadata, AI integration, phygital experiences y casos de uso avanzados en gaming, música y arte digital.',
  branches: [
    // R1: Estándares y mint
    {
      id: '6.1',
      title: '🔮 ERC-6551 Token Bound Accounts',
      description: '⚡ Revolutionary NFTs 2025: ERC-6551 TBA wallets, ERC-7857 Intelligent NFTs, dynamic on-chain identity. NFTs que poseen activos y ejecutan smart contracts.',
      units: [
        {
          id: '6.1.1',
          title: '🚀 ERC-6551 & TBA Implementation',
          description: '⚡ Token Bound Accounts: Cada NFT con su propia wallet. Gaming characters que poseen items, AI agents transferibles.',
          lessons: [
            {
              id: '6.1.1.1',
              title: '🤖 ERC-7857 Intelligent NFTs (iNFTs)',
              objective: 'Ahora sé crear NFTs con AI agents integrados y re-encryption',
              description: '⚡ Breakthrough 2025: iNFTs con AI agents seguros, re-encryption methods, transferencia de inteligencia. NFTs que evolucionan autónomamente.',
              duration: 15,
              difficulty: 'advanced',
              evidenceType: 'quest-onchain',
            ...
            {
              id: '6.1.1.2',
              title: '🎵 Music NFTs & Auto-Royalties 2025',
              objective: 'Ahora domino royalties automáticas para música y utility NFTs',
              description: '🎼 Music NFTs que generan $500M+/año, royalty splits automáticos, backstage access, voting rights artísticos. Streaming revenue distribution.',
              duration: 12,
              difficulty: 'advanced',
              evidenceType: 'quest-simulation',
              evidenceDescription: 'Crear Music NFT con royalty splitting automático',
              xpReward: 110,
              status: 'locked',
              isQuest: true,
              questType: 'simulation',
              questInstructions: 'Configurar Music NFT con múltiples beneficiarios de royalties y utility access',
              icon: '🎵',
            ...
            },
            {
              ...
              objective: 'Ahora sé configurar URIs persistentes para NFTs',
              description: 'IPFS CID, gateways públicos y privados, pinning strategies',
              duration: 12,
              difficulty: 'advanced',
              evidenceType: 'quest-simulation',
        ...
        },
        {
          id: '6.1.2',
          title: 'Mint ✪',
          description: 'Minteo práctico de NFTs en testnet',
          lessons: [
            {
              id: '6.1.2.1',
              title: '✪ Mint en Base Sepolia con imagen IPFS',
              objective: 'Ahora sé mintear NFTs con metadata descentralizada',
            ...
            {
              id: '6.1.2.2',
              title: '✪ Ver imagen en explorer y wallet',
              objective: 'Ahora sé verificar que NFTs se muestran correctamente',
              description: 'Verificación en BaseScan, MetaMask y otros explorers/wallets',
              duration: 8,
              difficulty: 'intermediate',
              evidenceType: 'screenshot',
            ...
            },
            {
              ...
              objective: 'Ahora sé manejar metadata mutable en NFTs',
              description: 'Casos de uso para metadata mutable y proceso de actualización',
              duration: 12,
              difficulty: 'advanced',
              evidenceType: 'quest-simulation',
        ...
        },
        {
          ...
          lessons: [
            ...
            },
            {
              ...
              objective: 'Ahora sé manejar aspectos legales de NFTs',
              description: 'Copyright, licensing models, commercial usage rights, IP considerations',
              duration: 12,
              difficulty: 'intermediate',
              evidenceType: 'quiz',
              evidenceDescription: 'Resolver casos de copyright y licensing ≥80%',
              xpReward: 100,
              status: 'locked',
              isQuest: false,
              icon: '🔺',
            ...
            },
            {
              ...
              description: 'Quiz consolidado de estándares, mint y best practices',
              duration: 5,
              difficulty: 'intermediate',
              evidenceType: 'quiz',
              evidenceDescription: 'Quiz final NFT fundamentals ≥80%',
              xpReward: 70,
              status: 'locked',
              isQuest: false,
              icon: '🎯',
    ...
    {
      id: '6.2',
      title: '🌍 Phygital NFTs & Corporate Integration',
      description: '🔮 2025 trends: 60% más transacciones phygital, Nike digital sneakers, luxury authentication, wine NFTs con tastings exclusivos. Corporate loyalty programs.',
      units: [
        {
          id: '6.2.1',
          title: '🏷️ Luxury Authentication & Digital Passports',
          description: '✨ Corporate NFTs 2025: Luxury fashion authentication, wine batch tracking, Nike digital sneakers. Brand loyalty programs integrados.',
          lessons: [
            {
              id: '6.2.1.1',
              title: '👑 Nike Digital Sneakers & Luxury Auth',
              objective: 'Ahora domino authentication systems para luxury brands',
              description: '🔥 Nike digital sneakers case study, luxury fashion authentication protocols, anti-counterfeit systems. Blockchain certificates inmutables.',
              duration: 14,
              difficulty: 'advanced',
              evidenceType: 'quest-simulation',
              evidenceDescription: 'Crear sistema de autenticación para producto luxury',
              xpReward: 120,
              status: 'locked',
              isQuest: true,
              questType: 'simulation',
              questInstructions: 'Diseñar digital passport para luxury item con authenticity verification',
              icon: '👑',
              tags: ['luxury-auth', 'nike-case', 'anti-counterfeit', 'brand-protection']
            },
            {
              id: '6.2.1.2',
              title: 'Triggers (oráculos, tiempo, eventos)',
              objective: 'Ahora sé implementar NFTs que responden a eventos',
              description: 'Price oracles, time-based changes, game events como triggers',
              duration: 15,
              difficulty: 'advanced',
              evidenceType: 'quest-simulation',
              evidenceDescription: 'Diseñar NFT que cambia con precio de ETH',
              xpReward: 120,
              status: 'locked',
              isQuest: true,
              questType: 'simulation',
            ...
            },
            {
              id: '6.2.1.3',
              title: 'Casos de uso',
              objective: 'Ahora sé identificar oportunidades para NFTs dinámicos',
        ...
        },
        {
          ...
          lessons: [
            ...
            {
              id: '6.2.2.2',
              title: 'Royalties en práctica',
              objective: 'Ahora sé configurar y cobrar royalties',
            ...
            },
            {
              ...
              objective: 'Ahora sé rastrear ventas y métricas NFT',
              description: 'Analizar Transfer events, sales volume, price trends en explorers',
              duration: 10,
              difficulty: 'intermediate',
              evidenceType: 'screenshot',
              evidenceDescription: 'Análisis de métricas de venta en explorer',
              xpReward: 75,
              status: 'locked',
              isQuest: false,
              icon: '📈',
        ...
        },
        {
          ...
          lessons: [
            {
              id: '6.2.3.1',
              title: '✪ Mint + listar + comprar con wallet secundaria',
              objective: 'Ahora sé completar el ciclo completo de NFT marketplace',
            ...
            {
              id: '6.2.3.2',
              title: '✪ Reclamar badge de creador',
              objective: 'Ahora soy un creador NFT certificado',
              description: 'Badge especial para completar todo el módulo NFT & Digital Media',
              duration: 5,
              difficulty: 'intermediate',
              evidenceType: 'quest-onchain',
              ...
              isQuest: true,
              questType: 'onchain',
              questInstructions: 'Claim NFT Creator badge tras completar módulo',
              icon: '🏆',
            ...
            },
            {
              ...
              difficulty: 'advanced',
              evidenceType: 'quiz',
              evidenceDescription: 'Quiz final NFT ecosystem ≥80%',
              xpReward: 100,
              status: 'locked',
              isQuest: false,
              icon: '🎯',
...
// Remaining modules M7-M20 as placeholders (será completado progresivamente)
const remainingModules: Module[] = Array.from({ length: 14 }, (_, i) => ({
  id: `M${i + 7}`,
  title: `Módulo ${i + 7}`,
  description: `Descripción detallada del módulo ${i + 7}`,
  objective: `Objetivo específico del módulo ${i + 7}`,
  branches: [],
  xpTotal: 1200 + i * 100,
  ...
  masterBadgeTitle: `Módulo ${i + 7} Master`,
  masterBadgeDescription: `Maestro del módulo ${i + 7}`,
  icon: ['🖼️', '🏛️', '🌐', '🔒', '🌉', '🧠', '📊', '📈', '👨‍💻', '🧪', '🔮', '💾', '🎮', '⚖️', '🚀'][i] || '📚',
