  ...
  const regenerateMetadata = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(`Metadata successfully regenerated from the correct contract!\n\nContract used: ${result.contractUsed}\nImage: ${result.imageUrl || 'Processing...'}`);
      } else {
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gray-800">
              {isOwner ? 'Your NFT-Wallet' : 'Crypto Gift For You'}
            </h1>
          </div>
          <p className="text-gray-600">
            {isOwner
              ? 'Manage your NFT and integrated wallet funds'
              : 'Someone special has sent you a unique gift on blockchain'
            }
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mt-8 grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg">
            ...
            <p className="text-sm text-gray-600">
              This NFT has an integrated wallet (ERC-6551) that can hold real cryptocurrencies.
            </p>
          </div>

          {/* Security */}
          <div className="bg-white rounded-2xl p-6 shadow-lg">
            <h3 className="font-bold text-gray-800 mb-3">🔒 Secure</h3>
            <p className="text-sm text-gray-600">
              Your funds are protected by audited contracts and social recovery.
            </p>
          </div>

          {/* No Fees */}
          <div className="bg-white rounded-2xl p-6 shadow-lg">
            <h3 className="font-bold text-gray-800 mb-3">⚡ Free Gas</h3>
            <p className="text-sm text-gray-600">
              All transactions have sponsored gas. No fees to pay!
            </p>
          </div>
        </div>
      </div>
