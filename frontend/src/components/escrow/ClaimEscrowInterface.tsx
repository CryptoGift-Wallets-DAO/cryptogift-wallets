      ...
      if (txResult && validationResult && typeof window !== 'undefined' && window.ethereum) {
        ...
        if (contractAddress) {
          try {
            ...
            const metadataUrl = `${typeof window !== 'undefined' ? window.location.origin : (process.env.NEXT_PUBLIC_BASE_URL || 'https://cryptogift-wallets.vercel.app')}/api/nft-metadata/${contractAddress}/${tokenId}`;
